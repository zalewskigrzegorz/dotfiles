...
client.retain(
    bank_id="greg",
    content="Project Redocly oklepuje certyfikaty w marcu — termin oddania DR jest 2026-03-15",
    context="redocly-deadline",
    metadata={"source": "claude-code", "type": "deadline"}
)

# recall
results = client.recall(bank_id="greg", query="kiedy są deadliny w Redocly")

# reflect
narrative = client.reflect(bank_id="greg", query="co wiesz o Redocly")
```
