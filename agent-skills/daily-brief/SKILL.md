...
- **1 (Monday) or 3 (Wednesday)** → **Mon/Wed mode**: include section 8 (Cyberpunks pre-sync rundown) before the closing. Sync is at 12:00 — if the brief runs after 12:00 it's still helpful (post-sync recap framing fine).
