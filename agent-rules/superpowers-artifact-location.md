---
description: Every AI-generated scratch artifact (plan, spec, brainstorm, analysis, audit, research note, design doc) lives in the bazgroly repo. Only human-facing docs (README, CHANGELOG, redocly/docs/, etc.) stay in the project repo.
alwaysApply: true
---
...
- Project documentation directories that ship with the codebase (`docs/`, `redocly/docs/`, `apps/*/docs/`, etc.)
