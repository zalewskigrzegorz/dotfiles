...
python .claude/design-assets/design-system/scripts/search-slides.py "metrics dashboard" -d layout

# Contextual recommendation
python .claude/design-assets/design-system/scripts/search-slides.py "traction slide" \
