...
- Kebab-case filenames: `{style}-{width}x{height}.{ext}`
- Date-prefix time-sensitive campaigns: `{YYMMDD}-{style}-{size}.png`
- One campaign folder groups all variants together
