...
```bash
# Deliverables
python3 ~/.claude/design-assets/scripts/cip/search.py "business card letterhead" --domain deliverable

# Design styles
python3 ~/.claude/design-assets/scripts/cip/search.py "luxury premium elegant" --domain style

# Industry guidelines
python3 ~/.claude/design-assets/scripts/cip/search.py "hospitality hotel" --domain industry

# Mockup contexts
python3 ~/.claude/design-assets/scripts/cip/search.py "office reception" --domain mockup
```
...
python3 ~/.claude/design-assets/scripts/cip/generate.py --brand "TopGroup" --logo /path/to/logo.png --industry "consulting" --set

# Pro model for 4K text rendering
python3 ~/.claude/design-assets/scripts/cip/generate.py --brand "TopGroup" --logo logo.png --deliverable "business card" --model pro

# Custom deliverables with aspect ratio
python3 ~/.claude/design-assets/scripts/cip/generate.py --brand "GreenLeaf" --logo logo.png --industry "organic food" --deliverables "letterhead,packaging,vehicle" --ratio 16:9

# Without logo (AI generates interpretation)
python3 ~/.claude/design-assets/scripts/cip/generate.py --brand "TechFlow" --deliverable "business card" --no-logo-prompt
```
...
python3 ~/.claude/design-assets/scripts/cip/render-html.py --brand "TopGroup" --industry "consulting" --images ./topgroup-cip --output presentation.html
```
