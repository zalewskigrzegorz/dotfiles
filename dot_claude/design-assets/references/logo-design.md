...
```bash
# Styles
python3 ~/.claude/design-assets/scripts/logo/search.py "minimalist clean" --domain style

# Color palettes
python3 ~/.claude/design-assets/scripts/logo/search.py "tech professional" --domain color

# Industry guidelines
python3 ~/.claude/design-assets/scripts/logo/search.py "healthcare medical" --domain industry
```
...
python3 ~/.claude/design-assets/scripts/logo/generate.py --prompt "coffee shop vintage badge" --style vintage
```
...
4. If yes, build the HTML gallery yourself (the `/ui-ux-pro-max` skill referenced here was removed 2026-05-24)
