...
**Brand:**
```bash
node .claude/design-assets/brand/scripts/inject-brand-context.cjs
node .claude/design-assets/brand/scripts/validate-asset.cjs <path>
```

**Tokens:**
```bash
node .claude/design-assets/design-system/scripts/generate-tokens.cjs -c tokens.json
node .claude/design-assets/design-system/scripts/validate-tokens.cjs -d src/
```
