---
description: Two-way DataGrip SQL workflow over the JetBrains MCP — write/replace SQL in the active console, read the open query, pull result rows back via clipboard. Explicit-invoke; not a skill.
argument-hint: "[what to query or check]"
---
